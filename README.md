...
- [poseljacob/agentic-video-editor](https://github.com/poseljacob/agentic-video-editor) - AI-powered video editor that turns raw footage and a creative brief into a polished ad using an ensemble of AI agents (Google Gemini &#43; FFmpeg)
...
- [AgriciDaniel/claude-ads](https://github.com/AgriciDaniel/claude-ads) - Comprehensive paid advertising audit &amp; optimization skill for Claude Code. 250&#43; checks across Google, Meta, YouTube, LinkedIn, TikTok, Microsoft &amp; Apple Ads with weighted scoring, parallel agents, industry templates, and AI creative generation.
### 📰 Recent Blog Posts:
